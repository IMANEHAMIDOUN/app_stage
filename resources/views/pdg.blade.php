...
<div class="w3-content" style="max-width:1600px">
  ...
  <header class="w3-container w3-center w3-padding-30 w3-white">
    <h1 class="w3-xxxlarge"><b>Maroc Taswiq</b></h1>
    <h6>Bienvenue sur notre application  pour  <span class="w3-tag">la gestion des stocks</span></h6>
  </header>

  <!-- Image header -->
  <header class="w3-display-container w3-wide" id="home">
    <img class="w3-image" src="img/authentique.jpg" alt="Fashion Blog" width="1600" height="1000">
    <div class="w3-display-left w3-padding-large">
      <h1 class="w3-text-blac">Gestion des </h1>
      <h1 class="w3-jumbo w3-text-Black w3-hide-small"><b>STOCKS</b></h1>
